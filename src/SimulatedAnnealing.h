...
class SimulatedAnnealing{
    public:
        ...
        std::vector<double> getBestSolution() const {return this->bestSolution;}
        double getBestFSolution() const {return this->bestFSolution;}
    ...
    private:
        ...
        double bestFSolution;               //Solution image
        ...
        void findMinimum(Domain const & domain, std::vector<double> & solution, double & fSolution);
